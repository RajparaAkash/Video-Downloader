...
public class DownloaderRoposo {


    public static class RoposoExecute extends AsyncTask<String, String, String> {

        Activity context;
        Dialog dialog;

        public RoposoExecute(Activity context) {
            ...
            try {
                ...
                while ((Line = reader.readLine()) != null) {
                    if (Line.contains("og:title")) {
                        String VideoTitle = Line.substring(Line.indexOf("og:title"));
        ...
        protected void onPostExecute(String s) {
            if (URLUtil.isValidUrl(s)) {
                ...
                try {
                    new MyMethod.DownloadFileFromURL(context, dialog, "Roposo").execute(s);
                } catch (Exception e) {
                    HideLoading(dialog);
                    setLoper();
